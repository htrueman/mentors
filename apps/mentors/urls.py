...
urlpatterns = [
    ...
    path('office/<uuid:pk>/', login_required(views.MentorOfficeView.as_view()), name='mentor_office'),
    path('mentoree/<int:pk>/', login_required(views.MentoreeDetailView.as_view()), name='mentoree_detail'),
]
